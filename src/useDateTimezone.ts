...
export function useDateTimezone(timezone?: string) {
  return useMemo(() => {
    ...
    return {
      // Format functions
      format: (date: DateInput, formatStr: string, options?: Parameters<typeof utils.format>[3]) => 
        utils.format(date, formatStr, tz, options),
      
      formatDateShort: (date: DateInput) => 
        utils.formatDateShort(date, tz),
      
      formatDateLong: (date: DateInput) => 
        utils.formatDateLong(date, tz),
      
      formatDateTime: (date: DateInput) => 
        utils.formatDateTime(date, tz),
      ...
      endOfDay: (date: DateInput) => 
        utils.endOfDay(date, tz),
      ...
      endOfWeek: (date: DateInput, options?: Parameters<typeof utils.endOfWeek>[1]) => 
        utils.endOfWeek(date, options, tz),
      
      startOfMonth: (date: DateInput) => 
        utils.startOfMonth(date, tz),
      
      endOfMonth: (date: DateInput) => 
        utils.endOfMonth(date, tz),
      
      startOfYear: (date: DateInput) => 
        utils.startOfYear(date, tz),
      
      endOfYear: (date: DateInput) => 
        utils.endOfYear(date, tz),
      ...
      formatDistanceToNow: (date: DateInput, options?: Parameters<typeof utils.formatDistanceToNow>[1]) => 
        utils.formatDistanceToNow(date, options, tz),
      
      formatRelative: (date: DateInput, baseDate: DateInput, options?: Parameters<typeof utils.formatRelative>[2]) => 
